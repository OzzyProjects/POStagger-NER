...
"""
Ce script extrait les entités nommées et les met à la volée au format universel. Pour ce faire, il s'appuie sur une base regex solide 
constituée d'un dict qui prend en clés les regex matchant pour les formes NLTK à remplacer 
...
ATTENTION : il n'est compatible qu'avec Python 3.8 et +
"""
